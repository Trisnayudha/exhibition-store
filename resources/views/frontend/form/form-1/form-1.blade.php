...
@section('content')
    @php
        ...
        if (!empty($data->deadline)) {
            $deadlineDate = \Carbon\Carbon::parse($data->deadline)->startOfDay();
    ...
    <div class="col-sm-9">
        <div class="container">
            <div class="container-fluid">
                ...
                @endif
                <!-- Wrapper form dengan position: relative -->
                <div id="forms-wrapper"
                        ...
                        <div class="card-body" style="margin-bottom:-7px;">
                            ...
                            <div class="content-login mb-25">
                                ...
                                <div class="alert alert-info alert-dismissible fade show" role="alert">
                                    <p> <small>The following information details will be received inquiries / notification
                                            on
                                            your
                            ...
                            <form action="{{ url('postPersonal') }}" method="POST" id="personalInformation">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12">
                                            <input type="text" name="name" id="name"
                                                class="form-control validation" placeholder="Input name"
                                                value="{{ old('name', $data->company_name ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 col-sm-12">
                                            <select name="phone_code" id="phone_code" class="form-control validation"
                                                ...
                                                @foreach ($phone_code as $prow)
                                                    <option {{ $data->ms_phone_code_id == $prow->id ? 'selected' : '' }}
                                ...
                                <div class="form-group mt-2 mb-2">
                                    <button class="btn btn-primary btn-lg btn-block loadpayment" type="submit">SAVE
                                        PERSONAL
                                        INFORMATION</button>
                                </div>
                            </form>
                    ...
                    <div class="card border-info mt-2">
                            ...
                            <form action="{{ url('postCompany') }}" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <small> <i>This Profile will also be used on Indonesia Miner Website and Event
                                                    Booklet</i></small>
                                            <textarea name="desc" id="desc" class="form-group summernote">{{ old('desc', $data->desc) }}
                                </textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-sm-12">
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="form-group">
                                            <label>Country <i class="text-danger"
                                                    title="This field is required">*</i></label>
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="form-group">
                                            <label>State <i class="text-danger"
                                                    title="This field is required">*</i></label>
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="form-group">
                                            <label>City <i class="text-danger"
                                                    title="This field is required">*</i></label>
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="form-group selection_eighteen">
                                ...
                                <select name="project_type" id="ms_company_class_id" class="form-control validation"
                    ...
                    @if ($isLocked)
                        ...
                        z-index: 999;
                    ">
                            <i class="ri-lock-fill" style="font-size:80px;"></i>
                            ...
                            <p style="max-width: 70%; text-align:center;">
                                For any special requests or additional support, please reach out to our operations team.
        ...
        <!-- Tombol Next/Previous ada di luar forms-wrapper agar tetap dapat diklik -->
        @include('frontend.form.button_dynamic', ['type' => $type, 'access' => $access])
