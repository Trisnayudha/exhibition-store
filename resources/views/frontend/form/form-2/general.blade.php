...
<div class="form-group">
    ...
    <input type="text" name="value1" id="value1" class="form-control" placeholder="Value Proposition 1">
</div>
<div class="form-group">
    <input type="text" name="value2" id="value2" class="form-control" placeholder="Value Proposition 2">
</div>
<div class="form-group">
    <input type="text" name="value3" id="value3" class="form-control" placeholder="Value Proposition 3">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" aria-label="Sizing example input"
            aria-describedby="inputGroup-sizing-default" name="video1" id="video1">
    </div>
    ...
    <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" aria-label="Sizing example input"
            aria-describedby="inputGroup-sizing-default" name="video2" id="video2">
    </div>
    <div class="input-group mb-3">
        <div class="input-group-prepend">
            <span class="input-group-text" id="inputGroup-sizing-default">
