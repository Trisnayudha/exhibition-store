<div class="container mt-5">
    <!-- Tombol Tambah -->
    <button class="btn btn-primary mb-3" onclick="tampilkanMedia()">Tambah</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="tambahMedia()">Tambah</button>
...
<script>
    ...
    // Panggil fungsi dataTabelMedia saat halaman dimuat
    ...
    function tambahMedia() {
        ...
        // Lakukan penambahan baris seperti pada fungsi tambahBaris yang sudah ada
        // ...
        $.ajax({
            type: 'POST',
