...
<script>
    ...
    // Panggil fungsi dataTabelNews saat halaman dimuat
    $(document).ready(function() {
        dataTabelNews();
    });

    function tampilkanNews() {
        // Tampilkan modal
    ...
    function tambahNews() {
        ...
        // Lakukan penambahan baris seperti pada fungsi tambahNews yang sudah ada
        // ...
        $.ajax({
            type: 'POST',
