<div class="container mt-5">
    <!-- Tombol Tambah -->
    <button class="btn btn-primary mb-3" onclick="tampilkanProjects()">Tambah</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="categoryInput">Products/Services in this projects</label>
                    <!-- Menggunakan Select2 untuk kategori -->
                    <select class="form-control" id="categoryInput">
                        <option value="Category 1">Category 1</option>
                        <option value="Category 2">Category 2</option>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="tambahProjects()">Tambah</button>
...
<script>
    ...
    // Panggil fungsi dataTabelProjects saat halaman dimuat
    ...
    function tambahProjects() {
        ...
        // Lakukan penambahan baris seperti pada fungsi tambahProjects yang sudah ada
        // ...
        $.ajax({
            type: 'POST',
