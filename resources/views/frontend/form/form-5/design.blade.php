        ...
        <form action="{{ url('sticker') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="table-responsive" id="sticker-basic-cart">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>BACK - Doff Laminated Indoor Vinyl Sticker 100x250cm + Polyfoam</td>
                            <td>IDR. 1.650.000</td>
                            <td>
                                ...
                                <input type="hidden" name="back-doof-product-basic" id="back-doof-product-basic"
                                    value="BACK - Doff Laminated Indoor Vinyl Sticker 100x250cm + Polyfoam">
                                ...
                                <input type="hidden" name="back-doof-image-basic" id="back-doof-image-basic"
                                    value="{{ asset('form5/sticker/basic.png') }}">
                            </td>
                        </tr>
                        <tr>
                            <td>SIDE - Doff Laminated Indoor Vinyl Sticker 100x250cm + Polyfoam</td>
                            <td>IDR. 1.650.000</td>
                            <td>
                                ...
                                <input type="hidden" name="side-doof-product-basic" id="side-doof-product-basic"
                                    value="SIDE - Doff Laminated Indoor Vinyl Sticker 100x250cm + Polyfoam">
                                <input type="hidden" name="back-doof-product-basic" id="back-doof-section-basic"
                                    value="Additional Sticker">
                        ...
                        <tr>
                            <td>TABLE - Doff Laminated Indoor Vinyl Sticker 100x60cm + Polyfoam</td>
                            <td>IDR. 1.000.000</td>
                            <td>
                                ...
                                <input type="hidden" name="table-doof-product-basic" id="table-doof-product-basic"
                                    value="TABLE - Doff Laminated Indoor Vinyl Sticker 100x60cm + Polyfoam">
                ...
                <div class="mt-5 p-1">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <img src="{{ asset('form5/sticker/basic.png') }}" alt="" class="img-thumbnail">
                        </div>
                        <div class="col-6">
