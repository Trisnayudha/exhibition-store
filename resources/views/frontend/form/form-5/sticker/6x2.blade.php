        ...
        <form action="{{ url('sticker') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="table-responsive" id="sticker-basic-cart">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>BACK - Doff Laminated Indoor Vinyl Sticker 600x300m + Polyfoam</td>
                            <td>-</td>
                            <td>
                                ...
                                {{-- <input type="hidden" name="back-doof-product-basic" id="back-doof-product-basic"
                                    value="BACK - Doff Laminated Indoor Vinyl Sticker 600x300m + Polyfoam">
                                ...
                                <input type="hidden" name="back-doof-image-basic" id="back-doof-image-basic"
                                    value="{{ asset('form5/sticker/6x2.jpg') }}"> --}}
                            </td>
                        </tr>
                        <tr>
                            <td>TABLE - Doff Laminated Indoor Vinyl Sticker 120x100x50cm + Polyfoam</td>
                            <td>-</td>
                            <td>
                                ...
                                {{-- <input type="hidden" name="table-doof-product-basic" id="table-doof-product-basic"
                                    value="TABLE - Doff Laminated Indoor Vinyl Sticker 120x100x50cm + Polyfoam">
                ...
                <div class="mt-5 p-1">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <img src="{{ asset('form5/sticker/6x2.jpg') }}" alt="" class="img-thumbnail">
                        </div>
                        <div class="col-6">
